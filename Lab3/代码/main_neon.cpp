...
// g++ main_neon.cpp train.cpp guessing_pthread_pool.cpp md5_neon.cpp -o main -O2
// g++ main_neon.cpp train.cpp guessing_pthread_dynamic.cpp md5_neon.cpp -o main -O2
// g++ -fopenmp main_neon.cpp train.cpp guessing_openMP.cpp md5_neon.cpp -o main -O2
...
int main()
{
    ...
    while (!q.priority.empty())
    {
        ...
        if (q.total_guesses - curr_num >= 100000)
        {
            ...
            // 在此处更改实验生成的猜测上限
            // 可以看看生成1e4,1e5,1e6,1e7,1e8个猜测数，探索加速比随总猜测数的变化。
            int generate_n = 1e8;
